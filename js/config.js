...
// IMPORTANTE: Reemplaza los valores con los tuyos
// ============================================================

const CONFIG = {
  supabase: {
    url: 'https://zmzyuccvlegklwohfjvp.supabase.co',          // ← Reemplaza
  ...
  cloudinary: {
    cloudName: 'duuletuej',                         // ← Reemplaza
    uploadPreset: 'pos_cafeteria_preset'                // ← Crea este preset en Cloudinary (unsigned)
  }
};
